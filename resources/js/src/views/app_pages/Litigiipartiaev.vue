<template>
  ...
  <div class= "d-flex justify-content-center" >
   <b-modal id="Dianasoftmodelaev"  
             ...
             :title="activeActionLocal+' Parti litigii'"
                            ...
                            <b-col  cols="2">
                                <validation-provider
                                  ...
                                  <b-form-input
                                    ...
                                    autocomplete="off"
                                    id="litigiu_id"
                                    v-model="editVarLocal.litigiu_id"
                                    placeholder="IDLitigiu" 
                                    
                                  />
                                  <label for="litigiu_id">IDLitigiu</label>
