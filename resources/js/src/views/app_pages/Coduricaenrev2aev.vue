<template>
  ...
  <div class= "d-flex justify-content-center" >
   <b-modal id="Dianasoftmodelaev"  
             ...
             :title="activeActionLocal+' Coduri CAEN rev2'"
                ...
                <b-row class="d-flex justify-content-center" >
                            ...
                            <b-col  cols="2">
                                <validation-provider
                                  ...
                                  <b-form-input
                                    ...
                                    autocomplete="off"
                                    id="cod_caen"
                                    v-model="editVarLocal.cod_caen"
                                    placeholder="Cod CAEN" 
                                    
                                  />
                                  <label for="cod_caen">Cod CAEN</label>
                            ...
                            <b-col  cols="2">
                                    ...
                                    <validation-provider
                                      ...
                                      <b-form-textarea
                                        id=".descriere"
                                         v-model="editVarLocal.descriere"
                                        rows="3"
                                        placeholder=".Descriere"
                                      />
                                       <small class="text-danger">{{ errors[0] }}</small>
                                       </validation-provider>
                                      <label for="label-.descriere">.Descriere</label>
                                    </div>     
                            </b-col>
