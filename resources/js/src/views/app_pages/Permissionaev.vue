<template>
  <div class= "d-flex justify-content-center" >
   <b-modal id="Dianasoftmodelaev"  
             ...
             :title="activeActionLocal+' Permission'"
             ...
             <br>
                ...
                <b-row >
                            ...
                            <b-col  cols="12"><div class="form-label-group">
                                  <b-form-input
                                    :readonly="activeActionLocal=='Vizualizează'"
                                    id="name" 
                                    v-model="editVarLocal.name"
                                    placeholder="Name" 
                                    :state="editVarLocal.name.length > 0"
                                  />
...
export default {
  ...
  methods: {
    modificaOptiune(){
      // console.log(this.editVarLocal.dianasoftmenuoption)
    },
    initTrHeight() {
