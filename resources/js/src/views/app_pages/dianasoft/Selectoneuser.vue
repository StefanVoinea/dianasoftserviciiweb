  ...
  methods:{
    ...
    getRecordList(){
         // this.showLoading=true
          ...
          if(JSON.parse(localStorage.getItem("utilizatoriOrdonati"))==null){
              const payLoad={} 
              ...
              this.$store.dispatch("app/api_Request",payLoad)
                                   .then(response=>{
                                           ...
                                           localStorage.setItem("utilizatoriOrdonati",JSON.stringify(response))
                                           
                                         
                              })
        }else{
          this.allRecords=JSON.parse(localStorage.getItem("utilizatoriOrdonati"))
