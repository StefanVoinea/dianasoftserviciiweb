...
import Datefinanciarepjaev from "./Datefinanciarepjaev.vue"
...
export default {
  ...
  data() {
    return {
        ...
        modelDisplayName:"Date financiare persoane juridice",
        editVar:{
          cui:"",
          an:"",
          indicator:"",
        ...
        columnDefs: [
                ...
                {
                  label: "Denumire indicator",
                  field: "val_den_indicator",
                  width: "300px",
                          type:"text",
                 showSortAsc:true,
                },
