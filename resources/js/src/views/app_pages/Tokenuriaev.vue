<template>
  ...
  <div class= "d-flex justify-content-center" >
   <b-modal id="Dianasoftmodelaev"  
             ...
             :title="activeActionLocal+' Tokenuri'"
                ...
                <b-row class="d-flex justify-content-center" >
                            ...
                            <b-col  cols="2">
                                    ...
                                    <validation-provider
                                      ...
                                      <b-form-textarea
                                        id=".access_token"
                                         v-model="editVarLocal.access_token"
                                        rows="3"
                                        placeholder=".Access token"
                                      />
                                       <small class="text-danger">{{ errors[0] }}</small>
                                       </validation-provider>
                                      <label for="label-.access_token">.Access token</label>
                                    </div>     
                            </b-col>
                            ...
                            <b-col  cols="2">
                                    ...
                                    <validation-provider
                                      ...
                                      <b-form-textarea
                                        id=".refresh_token"
                                         v-model="editVarLocal.refresh_token"
                                        rows="3"
                                        placeholder=".Refresh token"
                                      />
                                       <small class="text-danger">{{ errors[0] }}</small>
                                       </validation-provider>
                                      <label for="label-.refresh_token">.Refresh token</label>
                                    </div>     
                            </b-col>
                            ...
                            <b-col  cols="2">
                              <validation-provider
                                     ...
                                     <datacalendaristica 
                                          ...
                                          id="data_expirarii" 
                                          v-model="editVarLocal.data_expirarii"
                                          name="data_expirarii" 
                                          campDisplay="Data expirarii"> 
                                      </datacalendaristica>
                                      <small class="text-danger">{{ errors[0] }}</small>
                                       </validation-provider>     
                            </b-col>
                            ...
                            <b-col  cols="2">
                              <validation-provider
                                     ...
                                     <datacalendaristica 
                                          :readonly="activeActionLocal=='Vizualizează'"
                                          id="data_obtinere" 
                                          v-model="editVarLocal.data_obtinere"
                                          name="data_obtinere" 
                                          campDisplay="Data obtinerii"> 
                                      </datacalendaristica>
                                      <small class="text-danger">{{ errors[0] }}</small>
                                       </validation-provider>     
                            </b-col>
