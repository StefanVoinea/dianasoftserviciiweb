...
import Litigiicaleatacaev from "./Litigiicaleatacaev.vue"
...
export default {
  ...
  name:"litigiicaleatac",
  data() {
    return {
        refreshLocal:false, 
        idselectat:null,
        campFiltruStart:"",
        modelName:"litigiicaleatac",
        modelDisplayName:"Cale atac",
        editVar:{
          litigiu_id:"",
          data_declarare:"",
          parte_declaratoare:"",
        ...
        columnDefs: [
                ...
                {
                  label: "Data declarare",
                  field: "data_declarare",
                  width: "300px",
                  type:"date",
                ...
                {
                  label: "Parte declaratoare",
                  field: "parte_declaratoare",
                  width: "300px",
                          type:"text",
                 showSortAsc:true,
                },
