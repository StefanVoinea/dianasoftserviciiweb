<template>
  ...
  <div class= "d-flex justify-content-center" >
   <b-modal id="Dianasoftmodelaev"  
             ...
             :title="activeActionLocal+' Date financiare persoane juridice'"
                            ...
                            <b-col  cols="2">
                                <validation-provider
                                  ...
                                  <b-form-input
                                    ...
                                    autocomplete="off"
                                    id="indicator"
                                    v-model="editVarLocal.indicator"
                            ...
                            <b-col  cols="2">
                                <validation-provider
                                  ...
                                  <b-form-input
                                    ...
                                    autocomplete="off"
                                    id="val_indicator"
                                    v-model="editVarLocal.val_indicator"
                                    placeholder="Valoare indicator" 
                                    
                                  />
                                  <label for="val_indicator">Valoare indicator</label>
                                  <small class="text-danger">{{ errors[0] }}</small>
                                   </div>
                                       </validation-provider>
                            ...
                            <b-col  cols="2">
                                <validation-provider
                                  ...
                                  <b-form-input
                                    :readonly="activeActionLocal=='Vizualizează'"
                                    autocomplete="off"
                                    id="val_den_indicator"
                                    v-model="editVarLocal.val_den_indicator"
                                    placeholder="Denumire indicator" 
                                    
                                  />
                                  <label for="val_den_indicator">Denumire indicator</label>
                                  <small class="text-danger">{{ errors[0] }}</small>
                                   </div>
                                       </validation-provider>
