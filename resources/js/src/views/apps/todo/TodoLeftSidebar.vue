...
export default {
  ...
  setup() {
    ...
    const taskFilters = [
      { title: 'Toate task-urile', icon: 'MailIcon', route: { name: 'apps-todo' } },
      { title: 'Importante', icon: 'StarIcon', route: { name: 'apps-todo-filter', params: { filter: 'important' } } },
      { title: 'Executate', icon: 'CheckIcon', route: { name: 'apps-todo-filter', params: { filter: 'completed' } } },
      { title: 'Sterse', icon: 'TrashIcon', route: { name: 'apps-todo-filter', params: { filter: 'deleted' } } },
    ]
