  ...
  >
    ...
    >
      ...
      <div class="header-profile-sidebar">
        ...
        <span class="user-post text-capitalize">{{ contact.functia }}</span>
      </div>
    </header>
        ...
        <ul class="list-unstyled">
          ...
          <li class="mb-1">
            <feather-icon
              ...
              class="mr-75"
            />
            <span class="align-middle">{{ contact.telefon}}</span>
          </li>
          ...
          <li>
            <feather-icon
              ...
              class="mr-75"
            />
            <span class="align-middle">{{contact.departament+"  | "+contact.program_de_lucru }}</span>
          </li>
