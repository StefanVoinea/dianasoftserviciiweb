...
<body class="bodyfactura">
 ...
 @for($exemplar = 1; $exemplar <= 2; $exemplar++)
            ...
            <div class="container content"  style="page-break-before: always;">
...
<table class="table" width=100%>
	<tr>
    		...
    		<td  width=90%>
				...
				Suma : <strong>{{number_format($incasare->sum('suma'),2).' '.$incasare[0]->tip_valuta.' adica '.sumainlitere($incasare->sum('suma'),$incasare[0]->tip_valuta)}}</strong><br>
				<br>
...
<hr>
 ...
 <div >
		...
		<tr style="border-bottom:1pt solid black; page-break-inside: avoid !important;">
			...
			<td width=20% align="right">
	    		<h3>{{number_format($incasare->sum('suma'),2)." ".$incasare->max("tip_valuta")}}</h3>
			</td>
		</tr>
</table>	   
 </div>
