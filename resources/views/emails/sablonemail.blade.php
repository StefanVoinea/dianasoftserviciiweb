...
<td {{"align=center width=".$col["width"]."" }} >
{{$col["denumire"]}}
</td>
@endforeach
</tr>
...
@else
@if($col["type"]==="Number")
{{number_format(collect($randGrup3)[$col["col"]],2)}}
@else
...
{{number_format(round(collect($randGrup2->flatten()->values()->all())->sum($col["col"]),2),2)}}
@endif 
</td>
@endif
@endforeach
...
@else
@if($col["type"]==="Number")
{{number_format(collect($randGrup2)[$col["col"]],2)}}
@else
...
<td {{"align=".$col["align"]." width=".$col["width"]."" }} > 
@if(in_array($col["col"],$totalBy))  
{{number_format(round(collect($randGrup1->flatten()->values()->all())->sum($col["col"]),2),2)}}
@endif 
</td>
@endif
@endforeach
...
@else 
@if($col["type"]==="Number")
{{number_format(collect($randGrup1)[$col["col"]],2)}}
@else
...
<td {{"align=".$col["align"]." width=".$col["width"]."" }} > 
@if(in_array($col["col"],$totalBy))  
{{number_format(round(collect($randGrup->flatten()->values()->all())->sum($col["col"]),2),2)}}
@endif 
</td>
@endif
@endforeach
...
@else
@if($col["type"]==="Number")
{{number_format(collect($randGrup)[$col["col"]],2)}}
@else
...
<td {{"align=".$col["align"]." width=".$col["width"]."" }} > 
@if(in_array($col["col"],$totalBy))  
{{number_format(round(collect($rand->flatten()->values()->all())->sum($col["col"]),2),2)}}
@endif 
</td>
@endif
@endforeach
...
@else
@if($col["type"]==="Number")
{{number_format(collect($rand)[$col["col"]],2)}}
@else
...
@else 
<td {{"align=right width=".$col["width"]."" }} > 
@if(in_array($col["col"],$totalBy))  
