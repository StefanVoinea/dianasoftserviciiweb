    ...
    <table class="table">
    	<tr>
    		...
    		<td width=30% align="center">
	    		<h3><strong>BON DE CONSUM</strong>
				<strong>{{'NR. '.$document->nr_document.' / '.dateFormatAfisare($document->data_document)}}</strong></h3>
				<strong>{{' INTERIOR: '}}{{$document->interior?'DA':'NU'}}{{' GESTIUNE: '.$document->gestiune["denumire"]}}</strong> <br> 
 	  ...
 	  <table class="table table-condensed" style="border-collapse: collapse; border : 1px solid #a3a3a3;" width=100%  >
            ...
            <tr >
              <td  align ="center" style="border : 1px solid #a3a3a3;" width="5%">
                ...
                <td align ="center" style="border : 1px solid #a3a3a3;"  width="50%">
                   Denumire
                </td>
                <td  align ="center"  style="border : 1px solid #a3a3a3;"  width="5%">
                   Um
                ...
                <td style="border : 1px solid #a3a3a3;" align ="center" width="15%">
                ...
                <td style="border : 1px solid #a3a3a3;" align ="center"  width="15%">
                    ...
                    @foreach($document->detaliuconsum as $det_doc)
                      
                      <tr> 
                       <td style="border : 1px solid #a3a3a3;" align="center" width="5%">
                       {{ $i++ }}.
                       </td>
                      <td style="border : 1px solid #a3a3a3;" align="left" width="50%">
                       {{$det_doc->denumire  }} <br>
                      ...
                      <td style="border : 1px solid #a3a3a3;" align="right" width="15%">
                    ...
                    @endforeach 
             <tr> 
                       <td style="border : 1px solid #a3a3a3;" align="center" colspan="5" width="85%">
                       TOTAL
                         
                      </td>
                      <td style="border : 1px solid #a3a3a3;" align="right" width="15%">
                      {{ number_format(round($document->detaliuconsum->sum("valoare_intrare"),2),2) }}
