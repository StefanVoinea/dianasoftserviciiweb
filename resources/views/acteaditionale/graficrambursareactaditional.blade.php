 ...
 <table class="table table-condesed">
      ...
      <table class="table table-condesed" width=100 > 
                  ...
                  <td  colspan="8" width=100>
                     ...
                     ** Conform Contractului de credit (art 6.1.3. din CSC), debitorul/constituitorul ipotecii beneficiază de o reducere de {{numar_formatat($tabel["contract"]["disc_dob_rem"],2)}}%/lună la dobânda contractuala, sub conditia achitarii integrale a ratelor lunare datorate, cel tarziu in ziua de scadenta. Reducerea se acorda pentru oricare din ratele lunare datorate, sub conditia platii integrale la scadenta. Aceasta facilitate este acordata lunar, in cazul in care obligatiile de plata lunare sunt achitate integral, cu respectarea zilei scadentei stabilite. Neplata la scadenta a obligatiilor aferente unei luni calendaristice nu duce la pierderea facilitatii pentru obligatiile scadente viitoare.
                   </td>
                   </tr>  
