<!-- SA AFISEZE TRUNCHIAT SA NU MAREASCA RANDUL  -->
@extends('layouts.antet')

@section ('content')
          
<table class="table table-condesed  raport-table" border="1" style="border-collapse: collapse; table-layout: fixed;" width=100%>
    <thead>
               ...
               @endforeach
                @if($totalBy)
                  ...
                  @endforeach
                   ...
                   <tr>
                        <td colspan="{{ count($antetTabel) }}" style="height:10px;"></td>
                    </tr> 
                @endif
              @else
