    ...
    <table class="table" width="80%">
    	<tr>
    		<td width=100% align="center">
	    		<h3><strong>CHITANȚA</strong> Număr: <strong>{{$incasare->nr_document}}</strong>
...
<table class="table" width="80%">
	<tr>
    		<td >
				...
				Am primit de la : <strong>{{ $incasare->partener }}</strong>  C.U.I./C.N.P.: <strong>{{ $incasare->cui }}</strong>   <br>
				Suma : <strong>{{number_format($incasare->suma,2).' LEI adica '.nr2litere(number_format($incasare->suma,2))}}</strong><br>
				Reprezentând:   <strong>{{'Contravaloare factura nr.'.$vanzare->numar.'/'.dateFormatAfisare($vanzare->data)}}</strong> <br>
