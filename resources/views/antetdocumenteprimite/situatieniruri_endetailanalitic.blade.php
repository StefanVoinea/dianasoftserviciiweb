@extends('layouts.antetforcenewpage')
               ...
               <td style="border : 1px solid #a3a3a3;" align ="center" width="5%">
                ...
                <td style="border : 1px solid #a3a3a3;" align ="center" width="5%">
                    ...
                    @foreach($document->detaliunir as $det_doc)
                      ...
                      <td style="border : 1px solid #a3a3a3;" align="right" width="5%">
                      {{ number_format(round(($det_doc->valoare_intrare+$det_doc->valoare_taxa+$det_doc->valoare_navlu+$det_doc->valoare_transport+$det_doc->valoare_asigurare+$det_doc->valoare_alte_cheltuieli)/$det_doc->cantitate,2),2) }}
                      ...
                      <td style="border : 1px solid #a3a3a3;" align ="right" width="5%">
                         {{ number_format(round($det_doc->pret_vanzare*$det_doc->cantitate/(1+$det_doc->procent_tva_vanzare/100)-($det_doc->valoare_intrare+$det_doc->valoare_taxa+$det_doc->valoare_navlu+$det_doc->valoare_transport+$det_doc->valoare_asigurare+$det_doc->valoare_alte_cheltuieli),2),2) }}
                   </td>
                   <td style="border : 1px solid #a3a3a3;" align ="right" width="5%">
