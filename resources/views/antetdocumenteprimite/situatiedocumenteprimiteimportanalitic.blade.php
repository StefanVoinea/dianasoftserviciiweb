            ...
            <tr >
              <td  align ="center" style="border : 1px solid #a3a3a3;" width="5%">
                ...
                <td style="border : 1px solid #a3a3a3;" align ="center" width="10%">
                    ...
                    <center>({{$document->tip_valuta}})</center> 
                </td>
                <td style="border : 1px solid #a3a3a3;" align ="center" width="10%">
                ...
                <td style="border : 1px solid #a3a3a3;" align ="center"width="10%">
                 ...
                 <td style="border : 1px solid #a3a3a3;" align ="center" width="10%">
                    ...
                    @foreach($document->detaliudocumenteprimite as $det_doc)
                      ...
                      {{ number_format(round($det_doc->pret_intrare_in_valuta,2),2) }}
                         
                      </td>
                      <td style="border : 1px solid #a3a3a3;" align="right" width="10%">
                      {{ number_format(round($det_doc->valoare_intrare_in_valuta,2),2) }}
                    ...
                    @endforeach 
             <tr> 
                       <td style="border : 1px solid #a3a3a3;" align="center" colspan="5" width="50%">
                       TOTAL
                         
                      </td>
                      <td style="border : 1px solid #a3a3a3;" align="right" width="10%">
                      {{ number_format(round($document->detaliudocumenteprimite->sum("valoare_intrare_in_valuta"),2),2) }}
