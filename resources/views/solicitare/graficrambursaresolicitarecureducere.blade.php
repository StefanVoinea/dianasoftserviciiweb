...
@section ('content')
    ...
    <table class="table table-condesed">
     ...
     <tr>
        <td align="center" colspan="8" width=100>
          <h2><strong>
            LA CONTRACTUL DE CREDIT DE CONSUM CU COMPONENTA DE REFINANTARE <br>
            GARANTAT CU IPOTECĂ IMOBILIARĂ <br>
            NR. ________________  DIN DATA DE _________________________ <br>
 ...
 <table class="table table-condesed">
              ...
              <th align ="center" colspan="2" width=10>
               ...
               <th align ="center"  width=10>
                ...
                <th align ="center" width=10>
                 ...
                 <th align ="center" colspan="2" width=20>
                   {{numar_formatat($tabel["contract"]["procent_dobanda"]*12,2)}} %
                </th>
              ...
              <th align ="center" width=5>
                ...
                <th align ="right" width=10>
                 ...
                 <th align ="right" width=10>
                    ...
                    {{numar_formatat($rata->dob_rem,2).' '.strtolower($tabel["contract"]["tip_valuta"])}}
                </th>
                 <th align ="right" width=10>
                   {{numar_formatat(nz($rata->rata_lunara,0)+nz($rata->dob_rem,0),2).' '.strtolower($tabel["contract"]["tip_valuta"])}}
                </th>
                <th align ="right" width=10>
                     {{numar_formatat(nz($rata->dob_rem,0)-nz($rata->dobanda_cu_discount,0),2).' '.strtolower($tabel["contract"]["tip_valuta"])}}
                </th>
                <th align ="right" width=10>
                    {{numar_formatat(nz($rata->rata_lunara,0)+nz($rata->dobanda_cu_discount,0),2).' '.strtolower($tabel["contract"]["tip_valuta"])}}
                </th>
                ...
                <th align ="right" width=10>
                     {{numar_formatat($tabel["grafic"]->sum("dob_rem")-$tabel["grafic"]->sum("dobanda_cu_discount"),2).' '.strtolower($tabel["contract"]["tip_valuta"])}}
                </th>
                <th align ="right" width=10>
                    {{numar_formatat($tabel["grafic"]->sum("rata_lunara")+$tabel["grafic"]->sum("dobanda_cu_discount"),2).' '.strtolower($tabel["contract"]["tip_valuta"])}}
                </th>
      ...
      <table class="table table-condesed" width=100 > 
                  ...
                  <td  colspan="8" width=100>
                   ...
                   <tr>
                  <td  colspan="8" width=100>
                    ** Debitorul beneficiaza de o reducere lunara care se aplica la plata ratei lunare sub conditia achitarii  integrale a ratelor lunare datorate,cel tarziu in ziua scadenta. Aceasta facilitate este acordata lunar, in cazul in care obligatiile de plata lunare sunt achitate integral,cu respectarea zilei scadentei astfel cum a fost stabilita de parti. Neplata la scadenta a obligatiilor aferente unei luni calendaristice nu duce la pierderea facilitatii pentru obligatiile scadente viitoare.                          
