 ...
 <table class="table table-condesed">
            ...
            <tr style="border-bottom:1pt solid black; border-top:1pt solid black; page-break-inside: avoid !important;">
              <th align ="center" colspan="2" width=10>
               ...
               <th align ="center"  width=10>
                ...
                <th align ="center" width=10>
                    {{numar_formatat($tabel["contract"]["procent_dobanda"]-$tabel["contract"]["procent_discount"],2)}} %
                </th>
                 <th align ="center" width=10>
                    {{numar_formatat($tabel["contract"]["dae_cu_discount"],2)}} %
                </th>
                 <th align ="center" width=10>
              ...
              <th align ="center" width=5>
                ...
                <th align ="right" width=10>
                 ...
                 <th align ="right" width=10>
                    ...
                    {{numar_formatat($rata->dobanda_cu_discount,2).' '.strtolower($tabel["contract"]["tip_valuta"])}}
                </th>
                 <th align ="right" width=10>
                ...
                <th align ="right" width=10>
                 ...
                 <th align ="right" width=10>
                    ...
                    {{numar_formatat($tabel["grafic"]->sum("dobanda_cu_discount"),2).' '.strtolower($tabel["contract"]["tip_valuta"])}}
                </th>
                 <th align ="right" width=10>
      ...
      <table class="table table-condesed" width=100 > 
                  ...
                  <td  colspan="8" width=100>
                      ...
                      ** Conform Contractului de credit (art 6.1.3. din CSC), debitorul/constituitorul ipotecii beneficiază de o reducere de {{numar_formatat($tabel["contract"]["procent_discount"],2)}}%/lună la dobânda contractuala, sub conditia achitarii integrale a ratelor lunare datorate, cel tarziu in ziua de scadenta. Reducerea se acorda pentru oricare din ratele lunare datorate, sub conditia platii integrale la scadenta. Aceasta facilitate este acordata lunar, in cazul in care obligatiile de plata lunare sunt achitate integral, cu respectarea zilei scadentei stabilite. Neplata la scadenta a obligatiilor aferente unei luni calendaristice nu duce la pierderea facilitatii pentru obligatiile scadente viitoare.
                   </td>
                   </tr>  
