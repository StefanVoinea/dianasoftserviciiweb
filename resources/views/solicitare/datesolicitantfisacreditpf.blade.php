...
<tr>
 ...
 <tr>
     ...
     <td width="35" style="border: 1px solid black;font-weight: bold;">
         Consilier credit retail
     </td>
     <td width="60" style="border: 1px solid black;background-color:#DCDCDC;font-weight: bold;">
 ...
 @foreach($solicitare->partisolicitare as $parte)
         ...
         @if(strtoupper($parte->tip_persoana)=="PERSOANA FIZICA")
            ...
            <td width="5">
              ...
              <td width="35"  style="border: 1px solid black;font-weight: bold;background-color:#ffff00">
                 {{" ".$parte->tip_participant." "}}
             </td>
             <td width="60"  style="border: 1px solid black;font-weight: bold;">
            ...
            <tr>
               ...
               <td width="35" style="border: 1px solid black;font-weight: bold;">
                 ...
                 <td width="60" style="text-align:left;border: 1px solid black;background-color:#DCDCDC;font-weight: bold;">
