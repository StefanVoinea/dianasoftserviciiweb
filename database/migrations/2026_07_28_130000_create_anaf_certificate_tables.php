...
return new class extends Migration
{
    ...
    {
        // Pe servere, tabele si coloane pot exista deja, facute de mana dupa
        // acest fisier: se adauga doar ce lipseste.
        ...
        if (!Schema::hasTable('certificat_abonati')) {
        ...
        foreach (['anaf_societati', 'spv_mesaje', 'spv_solicitari', 'anaf_declaratii'] as $tabela) {
            if (Schema::hasColumn($tabela, 'certificat_id')) {
                continue;
            }
