...
class KitProgramTiparireTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        foreach (['server.php', 'curl-talcuri.php', 'agent.php', 'agent-functii.php', 'agent-lucreaza.php', 'cert-info.ps1', 'sign-pdf.ps1', 'merge-pdf.ps1', 'imprimante.ps1', 'print-pdf.ps1', 'itextsharp.dll'] as $fisier) {
