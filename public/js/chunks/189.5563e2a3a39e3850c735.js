  ...
  methods: {
    ...
    trimiteSolicitari: function trimiteSolicitari(cifuri) {
      ...
      var lot = function lot(i) {
        ...
        var acum = cifuri.slice(i, i + _this5.FIRME_PE_LOT);
        _this5.progres = {
          pas: 'solicitari',
          facut: i,
          total: cifuri.length,
        ...
        return _this5.$http.post('/anaf-societati/solicita', {
          cif: acum,
          reinterpreteaza: i === 0
        }).then(function (raspuns) {
          var _this5$erori;
          ...
          if (r.erori && r.erori.length) (_this5$erori = _this5.erori).push.apply(_this5$erori, Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_1__["default"])(r.erori));
    ...
    descarcaMesajeNoi: function descarcaMesajeNoi(rezumat) {
      ...
      var runda = function runda(trecute) {
        ...
        return _this6.$http.get('/spv', {
          ...
          if (d.erori && d.erori.length) (_this6$erori = _this6.erori).push.apply(_this6$erori, Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_1__["default"])(d.erori)); // Se oprește când nu mai rămâne nimic sau când o rundă n-a mai adus nimic.
    ...
    preiaRaspunsurile: function preiaRaspunsurile(rezumat) {
      ...
      var runda = function runda(trecute) {
        ...
        return _this7.$http.post("/spv/solicitari/preia?limita=".concat(_this7.RASPUNSURI_PE_LOT)).then(function (raspuns) {
          ...
          if (r.erori && r.erori.length) (_this7$erori = _this7.erori).push.apply(_this7$erori, Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_1__["default"])(r.erori)); // Cele fără răspuns încă nu se mai așteaptă: vin la o rulare viitoare.
