  ...
  methods: {
    ...
    ataseaza: function ataseaza() {
      ...
      this.$http.post("/anaf-certificate/".concat(this.certificatCurent.id, "/utilizatori"), this.utilizatorNou).then(function () {
        _this6.utilizatorNou = {
          email: '',
          nume: '',
          avertizare: false
        };

        _this6.reincarcaSiActualizeazaModalul();
      })["catch"](function (err) {
        _this6.eroareModal = _this6.mesajEroare(err, 'Utilizatorul nu a putut fi atașat');
      });
    },
    detaseaza: function detaseaza(utilizator) {
      ...
      this.$http["delete"]("/anaf-certificate/utilizatori/".concat(utilizator.id)).then(function () {
        ...
        _this7.eroareModal = _this7.mesajEroare(err, 'Utilizatorul nu a putut fi eliminat');
      });
    },
    ...
    reincarcaSiActualizeazaModalul: function reincarcaSiActualizeazaModalul() {
      ...
      this.$http.get('/anaf-certificate').then(function (raspuns) {
        _this8.certificate = raspuns.data.data || [];
        _this8.abonati = raspuns.data.abonati || [];
        _this8.certificatCurent = _this8.certificate.find(function (c) {
          return c.id === id;
        }) || _this8.certificatCurent;
      })["catch"](function (err) {
        _this8.eroareModal = _this8.mesajEroare(err, 'Lista nu a putut fi reîncărcată');
      });
    },
    aboneaza: function aboneaza() {
      ...
      this.$http.post('/anaf-certificate/abonare', {
        ...
        _this9.eroare = _this9.mesajEroare(err, 'Adresa nu a putut fi înscrisă');
      });
    },
