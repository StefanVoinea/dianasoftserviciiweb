...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      optionsLocal: JSON.parse(_store__WEBPACK_IMPORTED_MODULE_4__["default"].state.app.user),
      profileFile: null
    };
  },
  methods: {
    resetForm: function resetForm() {
      this.optionsLocal = JSON.parse(_store__WEBPACK_IMPORTED_MODULE_4__["default"].state.app.user);
    }
  },
  watch: {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    containsDigit: function containsDigit(str) {
      var digitRegex = /\d/;
      return digitRegex.test(str);
    },
    containsCapital: function containsCapital(str) {
      var capitalRegex = /[A-Z]/;
      return capitalRegex.test(str);
    },
    containsSpecialCharacter: function containsSpecialCharacter(str) {
      var specialCharRegex = /[!@#\$%\^\&*\)\(+=._-]+/;
      return specialCharRegex.test(str);
    },
    verificaParola: function verificaParola(parola) {
      if (parola.length < 8) {
        ...
        if (this.newPasswordValue != this.RetypePassword) {
          ...
          this.$store.dispatch("app/api_Request", payLoad).then(function (response) {
            if (response == "PAROLA NESCHIMBATA") {
              _this.$bvToast.toast('Parola identica cu parola existenta!', {
                title: "Atentie!",
                variant: 'danger',
                solid: false,
                appendToast: true,
              ...
              _this.$bvToast.toast('Parola a fost modificata cu succes!', {
        ...
        [
              ...
              _c(
                ...
                [
                  _c("b-img", {
                    ...
                    attrs: {
                      rounded: "",
                      src: _vm.optionsLocal.link_poza,
                      height: "80",
                    },
                  }),
                ],
          ...
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("b-card-text", [
                _vm._v("JPG, GIF or PNG. Max size of 800kB "),
              ]),
            ],
            1
          ),
                          ...
                          _c("b-form-input", {
                            ...
                            on: {
                              change: function ($event) {
                                return _vm.verificaParola(_vm.newPasswordValue)
                              },
                            },
                            model: {
...
/* harmony import */ var _plugins_globalHelpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../plugins/globalHelpers.js */ "./resources/js/src/plugins/globalHelpers.js");
...
var useInputImageRenderer = function useInputImageRenderer(inputEl, callback) {
  var inputImageRenderer = function inputImageRenderer() {
    ...
    if (file) {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('/utilizatori/importAvatar', formData, config).then(function (response) {
        _plugins_globalHelpers_js__WEBPACK_IMPORTED_MODULE_1__["globalHelpers"].updateCookiesLocal("user"); // this.$bvToast.toast("Upload efectuat cu succes!", {
