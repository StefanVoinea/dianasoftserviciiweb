...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    document.title = window.app_name + "->Chat";

    var listen = function listen() {
      /*
       Echo.channel("easyifn-dianasoft")
                    .listen(".ChatEvents.Event.Class", (e) => {
                       // this.getRecords()
                       console.log(e)
                       console.log("AM PRIMIT CHAT")
                       if(e.eveniment=="Modifica status"){
                        this.contacts.map((t)=>{
                          if(t.id==e.user_id){
                            t.status=e.status
    ...
    var fetchChatAndContacts = function fetchChatAndContacts() {
      _store__WEBPACK_IMPORTED_MODULE_2__["default"].dispatch('app-chat/fetchChatsAndContacts').then(function (response) {
        chatsContacts.value = JSON.parse(response.data.chatsContacts);
        contacts.value = JSON.parse(response.data.contacts); // eslint-disable-next-line no-use-before-define
    ...
    var openChatOfContact = function openChatOfContact(userId) {
      ...
      _store__WEBPACK_IMPORTED_MODULE_2__["default"].dispatch('app-chat/getChat', userId).then(function (response) {
        activeChat.value = response.data; // Set unseenMsgs to 0

        var contact = chatsContacts.value.find(function (c) {
          return c.id === userId;
        });
        if (contact) contact.unseenMsgs = 0; // Scroll to bottom
    ...
    var sendMessage = function sendMessage() {
      ...
      _store__WEBPACK_IMPORTED_MODULE_2__["default"].dispatch('app-chat/sendMessage', payload).then(function (response) {
        ...
        var contact = chatsContacts.value.find(function (c) {
          return c.id === response.data.contact.id;
        });
        ...
        if (contact === undefined) {
          ...
          activeChat.value.contact.lastMessage = newMessageData;
          activeChat.value.contact.unseenMsgs = 0; //activeChat.value.contact.chat=new Array() 

          activeChat.value.contact.chat = response.data.chat;
          chatsContacts.value.push(activeChat.value.contact);
        } else {
          // Add message to log
        ...
        chatInputMessage.value = ''; // contact.lastMessage = newMessageData
        // Scroll to bottom
    ...
    var showUserProfileSidebar = function showUserProfileSidebar() {
      profileUserData.value = JSON.parse(_store__WEBPACK_IMPORTED_MODULE_2__["default"].state.app.user);
...
/* harmony import */ var _ChatContact_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ChatContact.vue */ "./resources/js/src/views/apps/chat/ChatContact.vue");
/* harmony import */ var _UserProfileSidebar_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./UserProfileSidebar.vue */ "./resources/js/src/views/apps/chat/UserProfileSidebar.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    // SFC
    ChatContact: _ChatContact_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
    UserProfileSidebar: _UserProfileSidebar_vue__WEBPACK_IMPORTED_MODULE_11__["default"]
  },
  props: {
    chatsContacts: {
      type: Array,
  ...
  setup: function setup(props) {
    ...
    var searchFilterFunction = function searchFilterFunction(contact) {
      return contact.name ? contact.name.toLowerCase().includes(searchQuery.value.toLowerCase()) : "";
    };

    var filteredChatsContacts = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["computed"])(function () {
      return props.chatsContacts.filter(searchFilterFunction);
    });
    var filteredContacts = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["computed"])(function () {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props) {
    var formattedChatData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["computed"])(function () {
      ...
      var activeUserId = JSON.parse(_store__WEBPACK_IMPORTED_MODULE_5__["default"].state.app.user);
  ...
  methods: {
    ...
    toDate: function toDate(time) {
      ...
      return date_obj.toLocaleString(locale); //return date_obj.getDate() + ' '  + monthName+' '+date_obj.getYear()+'  '+ date_obj.getHours()+":"+date_obj.getMinutes()+":"+date_obj.getSeconds();
    }
  }
});
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("b-avatar", {
                          ...
                          attrs: {
                            size: "36",
                            src: _vm.activeChat.contact.link_poza,
                            badge: "",
                        ...
                        _c("h6", { staticClass: "mb-0" }, [
                          _vm._v(
                            "\n              " +
                              _vm._s(_vm.activeChat.contact.name) +
                              "\n            "
                          ),
                        ]),
                      ],
                  ...
                  [
                    _c("chat-log", {
                      attrs: {
                        ...
                        "profile-user-avatar":
                          _vm.profileUserDataMinimal.link_poza,
                      },
                    }),
                  ],
                  1
        ...
        ? _c("header", { staticClass: "user-profile-header" }, [
            ...
            _c("div", { staticClass: "header-profile-sidebar" }, [
              _c(
                ...
                [
                  _c("b-avatar", {
                    attrs: { size: "70", src: _vm.contact.link_poza },
                  }),
                  _vm._v(" "),
                  _c("span", {
              ...
              _c("span", { staticClass: "user-post text-capitalize" }, [
                _vm._v(_vm._s(_vm.contact.functia)),
              ]),
            ]),
          ])
        : _vm._e(),
            ...
            _c("ul", { staticClass: "list-unstyled" }, [
              ...
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _c("span", { staticClass: "align-middle" }, [
                    _vm._v(_vm._s(_vm.contact.telefon)),
                  ]),
                ],
                1
              ),
              ...
              _c(
                ...
                [
                  ...
                  _c("span", { staticClass: "align-middle" }, [
                    _vm._v(
                      _vm._s(
                        _vm.contact.departament +
                          "  | " +
                          _vm.contact.program_de_lucru
                      )
                    ),
                  ]),
                ],
  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "chat-info flex-grow-1" }, [
        _c("span", { staticClass: "card-text text-truncate" }, [
          _vm._v("\n      " + _vm._s(_vm.user.departament) + "\n      "),
        ]),
        _vm._v(" "),
        ...
        ? _c(
            ...
            [
              _c("small", { staticClass: "float-right mb-25 chat-time" }, [
                _vm._v(
                  _vm._s(
                    _vm.formatDateToMonthShort(_vm.user.lastMessage.time, {
                      hour: "numeric",
                      minute: "numeric",
                    })
                  )
                  ...
                  _c(
                    ...
                    [
                      _c("b-avatar", {
                        ...
                        attrs: {
                          size: "42",
                          src: _vm.profileUserMinimalData.link_poza,
                          variant: "transparent",
                          badge: "",
        ...
        "div",
        {
          ...
          class: {
            "chat-left":
              ...
              _vm.formattedChatData.activeUserId.id !== msgGrp.senderId,
          },
        },
        [
          _c(
            ...
            [
              _c("b-avatar", {
                ...
                attrs: {
                  ...
                  src:
                    msgGrp.senderId === _vm.formattedChatData.contact.id
                      ? _vm.formattedChatData.contact.link_poza
          ...
          _c(
            ...
            _vm._l(msgGrp.messages, function (msgData, index) {
              return _c(
                "div",
                ...
                [
                  _c("span", { staticStyle: { "font-size": "xx-small" } }, [
                    _vm._v(
                      _vm._s(
                        msgGrp.senderId === _vm.formattedChatData.contact.id &&
                          _vm.formattedChatData.contact.grup
                          ? _vm.formattedChatData.contact.name
                          : null
                      ) + " "
                    ),
                  ]),
                  ...
                  _c("span", { staticStyle: { "font-size": "xx-small" } }, [
                    _vm._v(
                      _vm._s(
                        _vm.formattedChatData.activeUserId.id !==
                          msgGrp.senderId && _vm.formattedChatData.contact.grup
                          ? msgGrp.senderName
                          : null
                      ) + " "
                    ),
                  ...
                  _vm._v(" "),
                  _c("span", { staticStyle: { "font-size": "xx-small" } }, [
                    _vm._v(_vm._s(_vm.toDate(msgData.time)) + " "),
                  ]),
                ]
              )
            }),
      ...
      _c("header", { staticClass: "chat-profile-header" }, [
        ...
        _c("div", { staticClass: "header-profile-sidebar" }, [
          _c(
            ...
            [
              _c("b-avatar", {
                attrs: { size: "70", src: _vm.profileUserData.link_poza },
              }),
              _vm._v(" "),
              _c("span", {
                staticClass: "avatar-status-xl",
          ...
          _vm._v(" "),
          _c("span", { staticClass: "user-post text-capitalize" }, [
            _vm._v(_vm._s(_vm.profileUserData.functia)),
          ]),
        ]),
      ]),
      _vm._v(" "),
...
_axios__WEBPACK_IMPORTED_MODULE_11__["default"].defaults.baseURL = window.api_url;
/* harmony default export */ __webpack_exports__["default"] = ({
  namespaced: true,
  state: {
    // Chat Search Query
  ...
  getters: {
    ...
    chatContacts: function chatContacts(state, getters) {
      ...
      return chatContacts.sort(function (x, y) {
        var chatDataX = getters.chatDataOfUser(x.id);
        var chatDataY = getters.chatDataOfUser(y.id);
  ...
  mutations: {
    ...
    RECEIVE_CHAT_MESSAGE: function RECEIVE_CHAT_MESSAGE(state, payload) {
      if (payload.chatData) {
        // If there's already chat. Push msg to existing chat
        state.chats[Object.keys(state.chats).find(function (key) {
          return key == payload.user_id;
        })].msg.push(JSON.parse(payload.mesaj));
      } else {
        // Create New chat and add msg
        var chatId = payload.user_id;
        vue__WEBPACK_IMPORTED_MODULE_12___default.a.set(state.chats, [chatId], {
          isPinned: false,
          msg: [JSON.parse(payload.mesaj)]
        });
      }
    },
    // API AFTER
    ...
    SELECTEAZA_CONTACT: function SELECTEAZA_CONTACT(state, payload) {
      // state.contacts[Object.keys(state.contacts).find(key => key == contact.id)].selectat = contact.selectat
      state.contacts.map(function (t) {
        if (t.id == payload.contact.id) {
          // console.log(t)
          t.selectat = payload.contactSelectat; // console.log(t)
        }
      });
    },
    DESELECTEAZA_CONTACTE: function DESELECTEAZA_CONTACTE(state) {
      state.contacts.map(function (t) {
        return t.selectat = false;
      });
    },
  ...
  actions: {
    ...
    // API CALLS
    addGroup: function addGroup(_ref4, payload) {
      var getters = _ref4.getters,
          commit = _ref4.commit,
          dispatch = _ref4.dispatch,
          rootState = _ref4.rootState;
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].defaults.headers.common['Authorization'] = 'Bearer ' + rootState.token;
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].defaults.headers.common['AuthorizationHeader'] = JSON.parse(rootState.societateaCurenta).id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_11__["default"].post("/utilizatori/storegroup", {
          payload: payload
    ...
    receiveChatMessage: function receiveChatMessage(_ref5, payload) {
    ...
    selecteazaContact: function selecteazaContact(_ref6, payload) {
    ...
    deselecteazaContacte: function deselecteazaContacte(_ref7) {
    ...
    */
    fetchChatsAndContacts: function fetchChatsAndContacts(_ref8) {
      var commit = _ref8.commit,
          rootState = _ref8.rootState;
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].defaults.headers.common['Authorization'] = 'Bearer ' + rootState.app.token;
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].defaults.headers.common['AuthorizationHeader'] = JSON.parse(rootState.app.societateaCurenta).id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_11__["default"].get("/chat/contacteChat", {
          params: {
            q: ""
          }
        }).then(function (response) {
    ...
    fetchContacts: function fetchContacts(_ref9) {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].defaults.headers.common['AuthorizationHeader'] = JSON.parse(rootState.app.societateaCurenta).id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_11__["default"].get("/chat/contacte", {
          params: {
            q: ""
          }
        }).then(function (response) {
    ...
    getProfileUser: function getProfileUser() {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_11__["default"].get('/apps/chat/users/profile-user').then(function (response) {
    ...
    getChat: function getChat(_ref10, userId) {
      var commit = _ref10.commit,
          rootState = _ref10.rootState;
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].defaults.headers.common['Authorization'] = 'Bearer ' + rootState.app.token;
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].defaults.headers.common['AuthorizationHeader'] = JSON.parse(rootState.app.societateaCurenta).id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_11__["default"].post('/chat/chats', {
          userId: userId
        }).then(function (response) {
    ...
    */
    // API CALLS
    sendMessage: function sendMessage(_ref11, payload) {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].defaults.headers.common['AuthorizationHeader'] = JSON.parse(rootState.app.societateaCurenta).id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_11__["default"].post("/chat/sendChatMessage", {
          payload: payload
        }).then(function (response) {
          payload.chatData = getters.chatDataOfUser(payload.id); // if(!payload.chatData) { dispatch("fetchChatContacts") }
    ...
    // API CALLS
    changeAvatar: function changeAvatar(_ref12, formData, config) {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].defaults.headers.common['AuthorizationHeader'] = JSON.parse(rootState.societateaCurenta).id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_11__["default"].post("/utilizatori/modificaAvatar", formData, config).then(function (response) {
          resolve(response);
        })["catch"](function (error) {
          reject(error);
        });
    ...
    markSeenAllMessages: function markSeenAllMessages(_ref13, id) {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].defaults.headers.common['AuthorizationHeader'] = JSON.parse(rootState.societateaCurenta).id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_11__["default"].post("/chat/mark-all-seen", {
          id: id
        }).then(function (response) {
    ...
    toggleIsPinned: function toggleIsPinned(_ref14, payload) {
      var commit = _ref14.commit,
          rootState = _ref14.rootState;
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].defaults.headers.common['Authorization'] = 'Bearer ' + rootState.token;
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].defaults.headers.common['AuthorizationHeader'] = JSON.parse(rootState.societateaCurenta).id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_11__["default"].post("/chat/set-pinned/", {
