  ...
  actions: {
    ...
    addEvent: function addEvent(ctx, _ref2) {
      ...
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/apps/calendar/events', {
          event: event
    ...
    updateEvent: function updateEvent(ctx, _ref3) {
      ...
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("/apps/calendar/events/".concat(event.id), {
          event: event
        }).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
    ...
    removeEvent: function removeEvent(ctx, _ref4) {
      var id = _ref4.id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_1__["default"]["delete"]("/apps/calendar/events/".concat(id)).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
...
/* harmony import */ var _fullcalendar_core_locales_ro__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @fullcalendar/core/locales/ro */ "./node_modules/@fullcalendar/core/locales/ro.js");
/* harmony import */ var _fullcalendar_core_locales_ro__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_fullcalendar_core_locales_ro__WEBPACK_IMPORTED_MODULE_8__);
...
function userCalendar() {
  ...
  var addEvent = function addEvent(eventData) {
    ...
    */
    ...
    payLoad.requestUrl = "/calendarevent/store";
    _store__WEBPACK_IMPORTED_MODULE_12__["default"].dispatch("app/api_Request", payLoad).then(function (response) {
      refetchEvents();
    });
  }; // ------------------------------------------------
  // updateEvent
  ...
  var updateEvent = function updateEvent(eventData) {
    ...
    var payLoad = eventData;
    payLoad.requestType = "post";
    payLoad.requestUrl = "/calendarevent/edit/" + eventData.id;
    _store__WEBPACK_IMPORTED_MODULE_12__["default"].dispatch("app/api_Request", payLoad).then(function (response) {
      var updatedEvent = response;
  ...
  var removeEvent = function removeEvent() {
    ...
    var payLoad = {};
    payLoad.requestType = "post";
    payLoad.requestUrl = "/calendarevent/delete/" + eventId;
    _store__WEBPACK_IMPORTED_MODULE_12__["default"].dispatch("app/api_Request", payLoad).then(function (response) {
      removeEventInCalendar(eventId);
    });
  }; // ------------------------------------------------
  ...
  var fetchEvents = function fetchEvents(info, successCallback) {
    ...
    var payLoad = {};
    payLoad.requestType = "post";
    payLoad.requestUrl = "/calendareventsusercurent";
    payLoad.calendars = selectedCalendars.value.join(',');
    _store__WEBPACK_IMPORTED_MODULE_12__["default"].dispatch("app/api_Request", payLoad).then(function (response) {
  ...
  var calendarOptions = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_11__["ref"])({
    ...
    locale: _fullcalendar_core_locales_ro__WEBPACK_IMPORTED_MODULE_8___default.a,
    headerToolbar: {
