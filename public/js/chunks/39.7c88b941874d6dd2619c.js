  ...
  methods: {
    ...
    loadMessages: function loadMessages() {
      ...
      return this.$http.get('/spv', {
        ...
        if (response.data && response.data.success) {
          ...
          var descarcare = response.data.descarcare || {};
          var arata = !(tacut && !payload.noi);
          if (!descarcare.ramase) _this10.infoDescarcare = arata ? _this10.rezumatCitire(payload, descarcare) : '';
          /*
          ...
          return descarcare.ramase ? _this10.aduceRestul(payload, descarcare, arata) : Promise.resolve();
        }
    ...
    aduceRestul: function aduceRestul(payload, descarcare, arata) {
      ...
      var incaUnLot = function incaUnLot() {
        ...
        if (arata) {
          _this11.infoDescarcare = "".concat(adunate.descarcate, " documente aduse, ") + "".concat(adunate.ramase, " de adus. V\u0103 rug\u0103m a\u0219tepta\u021Bi...");
        }

        return _this11.$http.get('/spv/descarca-lipsa', {
          params: params
        }).then(function (response) {
          var _adunate$erori;
          ...
          if (response.data && response.data.data && Array.isArray(response.data.data.mesaje)) {
            _this11.messages = response.data.data.mesaje;
          }
      ...
      return incaUnLot().then(function () {
        if (arata) _this11.infoDescarcare = _this11.rezumatCitire(payload, adunate);
      })["catch"](function (err) {
        _this11.error = err.response && err.response.data && err.response.data.message ? err.response.data.message : 'Aducerea documentelor rămase s-a oprit';
      });
    },
    ...
    reglaCronometrul: function reglaCronometrul() {
      ...
      this.cronometru = window.setInterval(function () {
        if (!_this12.loading) _this12.loadMessages(true);
      }, minute * 60 * 1000);
    }
  }
});
