  ...
  methods: {
    ...
    sterge: function sterge(declaratie) {
      ...
      this.$bvModal.msgBoxConfirm("\u0218terge\u021Bi declara\u021Bia ".concat(declaratie.tip, " pentru CUI ").concat(declaratie.cui, "?"), {
        ...
        _this15.$http["delete"]("/declaratii/".concat(declaratie.id)).then(function () {
          _this15.notifica('Declarația a fost ștearsă', 'success');

          _this15.incarcaLista();
        })["catch"](function (err) {
          _this15.eroare = _this15.mesajEroare(err, 'Ștergerea a eșuat');
        });
      });
    },
    mesajEroare: function mesajEroare(err, implicit) {
    ...
    explicaEroarea: function explicaEroarea(declaratie) {
      ...
      fetch(adresa, {
        ...
        return _this16.citesteFluxul(raspuns.body.getReader());
      })["catch"](function (err) {
        ...
        _this16.explicatieEroare = "Explica\u021Bia nu a putut fi ob\u021Binut\u0103 (".concat(err.message, ").");
      });
    },
