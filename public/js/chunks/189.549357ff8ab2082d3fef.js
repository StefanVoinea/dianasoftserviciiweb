  ...
  methods: {
    ...
    incarcaLista: function incarcaLista() {
      ...
      this.$http.get('/anaf-certificate').then(function (raspuns) {
        _this.certificate = raspuns.data.data || [];
        _this.abonati = raspuns.data.abonati || [];
        _this.zileAvertizare = raspuns.data.zile_avertizare || 30;
      })["catch"](function (err) {
        _this.eroare = _this.mesajEroare(err, 'Nu s-au putut încărca certificatele');
      })["finally"](function () {
    ...
    descarcaKit: function descarcaKit() {
      ...
      this.$http.get('/anaf-certificate/kit', {
        ...
        _this2.info = token ? "Kit desc\u0103rcat. Codul de acces pentru acel calculator: ".concat(token) : 'Kit descărcat.';
      })["catch"](function () {
        _this2.eroare = 'Kitul nu a putut fi generat.';
      })["finally"](function () {
        _this2.kitInCurs = false;
      });
    },
    descopera: function descopera() {
      ...
      this.$http.post('/anaf-certificate/descopera', this.bridgeNou).then(function (raspuns) {
        ...
        _this3.info = "".concat(parti.join(', '), ".");

        if (entitati.erori && entitati.erori.length) {
          _this3.eroare = entitati.erori.join(' | ');
        }

        _this3.incarcaLista();
      })["catch"](function (err) {
        _this3.eroare = _this3.mesajEroare(err, 'Certificatele nu au putut fi citite');
      })["finally"](function () {
        _this3.sincronizareInCurs = false;
      });
    },
    ...
    rasfoieste: function rasfoieste(cale) {
      ...
      this.$http.get("/anaf-certificate/".concat(this.bridgeFormular.id, "/foldere"), {
        ...
        var data = _ref.data;
        _this4.foldere = data.data.foldere;
        _this4.folderCurent = data.data.cale;
        _this4.folderParinte = data.data.parinte;
      })["catch"](function (err) {
        _this4.eroareFoldere = _this4.mesajEroare(err, 'Dosarele nu au putut fi citite'); // La o cale greșită se rămâne totuși cu ceva de ales: discurile.

        if (cale !== '') _this4.rasfoieste('');
      })["finally"](function () {
        _this4.foldereInCurs = false;
      });
    },
    ...
    salveazaBridge: function salveazaBridge() {
      ...
      this.$http.put("/anaf-certificate/".concat(this.bridgeFormular.id), {
        ...
        _this5.eroare = _this5.mesajEroare(err, 'Configurarea nu a putut fi salvată');
      });
    },
    ...
    reinnoiesteLicenta: function reinnoiesteLicenta(certificat) {
      ...
      this.$http.post("/anaf-certificate/".concat(certificat.id, "/licenta")).then(function (_ref2) {
        var data = _ref2.data;
        _this6.info = data.message;

        _this6.incarcaLista();
      })["catch"](function (err) {
        _this6.eroare = _this6.mesajEroare(err, 'Licența nu a putut fi trimisă');
      })["finally"](function () {
        _this6.licentaInCurs = null;
      });
    },
    ...
    ataseaza: function ataseaza() {
      ...
      this.$http.post("/anaf-certificate/".concat(this.certificatCurent.id, "/utilizatori"), this.utilizatorNou).then(function () {
        _this7.utilizatorNou = {
          email: '',
          nume: '',
          avertizare: false
        };

        _this7.reincarcaSiActualizeazaModalul();
      })["catch"](function (err) {
        _this7.eroareModal = _this7.mesajEroare(err, 'Utilizatorul nu a putut fi atașat');
      });
    },
    detaseaza: function detaseaza(utilizator) {
      ...
      this.$http["delete"]("/anaf-certificate/utilizatori/".concat(utilizator.id)).then(function () {
        _this8.reincarcaSiActualizeazaModalul();
      })["catch"](function (err) {
        _this8.eroareModal = _this8.mesajEroare(err, 'Utilizatorul nu a putut fi eliminat');
      });
    },
    ...
    reincarcaSiActualizeazaModalul: function reincarcaSiActualizeazaModalul() {
      ...
      this.$http.get('/anaf-certificate').then(function (raspuns) {
        _this9.certificate = raspuns.data.data || [];
        _this9.abonati = raspuns.data.abonati || [];
        _this9.certificatCurent = _this9.certificate.find(function (c) {
          return c.id === id;
        }) || _this9.certificatCurent;
      })["catch"](function (err) {
        _this9.eroareModal = _this9.mesajEroare(err, 'Lista nu a putut fi reîncărcată');
      });
    },
    aboneaza: function aboneaza() {
      ...
      this.$http.post('/anaf-certificate/abonare', {
        ...
        _this10.incarcaLista();
      })["catch"](function (err) {
        _this10.eroare = _this10.mesajEroare(err, 'Adresa nu a putut fi înscrisă');
      });
    },
    dezaboneaza: function dezaboneaza(abonat) {
      ...
      this.$http["delete"]("/anaf-certificate/abonare/".concat(abonat.id)).then(function () {
        _this11.incarcaLista();
      })["catch"](function (err) {
        _this11.eroare = _this11.mesajEroare(err, 'Ștergerea a eșuat');
      });
    },
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    deDepus: function deDepus() {
      return this.declaratii.filter(function (d) {
        return d.semnat && !d.index_recipisa;
      });
    },
    ...
    deDescarcat: function deDescarcat() {
      return this.declaratii.filter(function (d) {
        return d.index_recipisa && !d.cale_recipisa && !d.arhiva_recipisa;
      });
    },
  ...
  methods: {
    ...
    incarca: function incarca() {
      ...
      this.deIncarcat.forEach(function (fisier) {
        return formular.append('fisiere[]', fisier);
      });
      this.$http.post('/declaratii', formular, {
        headers: {
          'Content-Type': 'multipart/form-data'
        }
      }).then(function (raspuns) {
        var incarcate = raspuns.data.data || [];
        var erori = raspuns.data.erori || [];
        _this5.fisiere = [];
        _this5.dinFolder = [];
        ...
        _this5.notifica(parti.join(', '), respinse || erori.length ? 'warning' : 'success');

        if (erori.length) {
          _this5.eroare = erori.join(' | ');
        ...
        var deSemnatAcum = _this5.semneazaDupaValidare && _this5.poateSemna ? incarcate.filter(function (d) {
          return d.pas === 'validat';
        }) : [];
        return _this5.semneazaValidate(deSemnatAcum, incarcate.filter(function (d) {
          return d.pas === 'semnat';
        }));
      })["catch"](function (err) {
        var date = err.response && err.response.data;
        _this5.eroare = date && date.erori && date.erori.length ? date.erori.join(' | ') : _this5.mesajEroare(err, 'Nu s-au putut încărca declarațiile');
      })["finally"](function () {
        _this5.incarcaInCurs = false;
    ...
    semneazaValidate: function semneazaValidate(declaratii) {
      ...
      var urmatoarea = function urmatoarea(i) {
        if (i >= declaratii.length) {
          if (esuate.length) {
            _this7.eroare = "Nu s-au putut semna: ".concat(esuate.join(' | '));
          }

          _this7.notifica("".concat(declaratii.length - esuate.length, " din ").concat(declaratii.length, " semnate"), esuate.length ? 'warning' : 'success');

          return null;
        }

        var declaratie = declaratii[i];
        _this7.semnareInCurs = "".concat(declaratie.tip, " (").concat(i + 1, " din ").concat(declaratii.length, ")");
        return _this7.$http.post("/declaratii/".concat(declaratie.id, "/semneaza")).then(function () {
          reusite.push(declaratie);
        })["catch"](function (err) {
          esuate.push("".concat(declaratie.tip, " ").concat(declaratie.cui, ": ").concat(_this7.mesajEroare(err, 'semnare eșuată')));
        }).then(function () {
      ...
      return urmatoarea(0).then(function () {
        _this7.semnareInCurs = ''; // Se adună doar cele semnate acum, nu tot ce e semnat în tabel.

        if (_this7.tiparire && reusite.length) {
          _this7.semnareInCurs = 'fișierul pentru tipărire';
          return _this7.descarcaPentruTiparire(reusite.map(function (d) {
            return d.id;
          })).then(function () {
            _this7.semnareInCurs = '';
          });
        }

        return null;
      }).then(function () {
        return _this7.depuneDinSesiune([].concat(Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_1__["default"])(venitesemnate), reusite));
      });
    },
    ...
    descarcaPentruTiparire: function descarcaPentruTiparire(ids) {
      ...
      return this.$http.post('/declaratii/concateneaza', Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])(Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, date), {}, {
        ...
        _this8.$bvToast.toast("".concat(data.data.documente, " documente trimise la \u201E").concat(data.data.imprimanta, "\u201D."), {
        ...
        _this8.eroare = "".concat(ceAnume, " sunt gata, dar tip\u0103rirea nu a reu\u0219it: ").concat(motiv, " Se descarc\u0103 fi\u0219ierul.");
        return _this8.descarcaFisierUnit(date, ids.length);
      });
    },
    ...
    descarcaFisierUnit: function descarcaFisierUnit(date, cate) {
      ...
      return this.$http.post('/declaratii/concateneaza', date, {
        ...
        _this9.eroare = 'Nici fișierul pentru tipărire nu a putut fi creat.';
      });
    },
    ...
    depuneSemnate: function depuneSemnate() {
      ...
      this.$bvModal.msgBoxConfirm("Se trimit acum la ANAF ".concat(numite, " (").concat(listate, "). Dup\u0103 trimitere nu mai pot fi retrase."), {
        ...
        return _this10.trimiteLaAnaf(declaratii);
      });
    },
    ...
    trimiteLaAnaf: function trimiteLaAnaf(declaratii) {
      ...
      var urmatoarea = function urmatoarea(i) {
        if (i >= declaratii.length) {
          if (esuate.length) {
            _this11.eroare = "Nu s-au putut depune: ".concat(esuate.join(' | '));
          }

          _this11.notifica("".concat(declaratii.length - esuate.length, " din ").concat(declaratii.length, " depuse"), esuate.length ? 'warning' : 'success');

          return null;
        }

        var declaratie = declaratii[i];
        _this11.depunereMesaj = "".concat(declaratie.tip, " (").concat(i + 1, " din ").concat(declaratii.length, ")");
        return _this11.$http.post("/declaratii/".concat(declaratie.id, "/depune"))["catch"](function (err) {
          esuate.push("".concat(declaratie.tip, " ").concat(declaratie.cui, ": ").concat(_this11.mesajEroare(err, 'depunere eșuată')));
        }).then(function () {
          return urmatoarea(i + 1);
        });
      };
    ...
    actiune: function actiune(declaratie, tip) {
      ...
      this.$http.post("/declaratii/".concat(declaratie.id, "/").concat(tip)).then(function () {
        _this12.notifica(mesaje[tip], 'success');

        _this12.incarcaLista();
      })["catch"](function (err) {
        _this12.eroare = _this12.mesajEroare(err, 'Operația a eșuat');
    ...
    verificaRecipise: function verificaRecipise() {
      ...
      this.$http.post('/declaratii/recipise').then(function (raspuns) {
        var rezultat = raspuns.data.data;
        _this13.ultimaDescarcare = _this13.acum();
        _this13.ultimaDescarcareNumar = rezultat.descarcate || 0;
        window.localStorage.setItem('declaratii_recipise_ultima', JSON.stringify({
          la: _this13.ultimaDescarcare,
          descarcate: _this13.ultimaDescarcareNumar
        }));

        if (!tacut || rezultat.descarcate > 0) {
          _this13.notifica("Verificate: ".concat(rezultat.verificate, ", recipise desc\u0103rcate: ").concat(rezultat.descarcate), rezultat.descarcate > 0 ? 'success' : 'info');
        }

        if (rezultat.erori && rezultat.erori.length) {
          _this13.eroare = rezultat.erori.join(' | ');
        }

        _this13.incarcaLista(); // Recipisele venite acum se pot aduna într-un singur fișier de tipărit.


        var aduse = rezultat.descarcate_id || [];

        if (_this13.tiparireRecipise && aduse.length) {
          return _this13.descarcaPentruTiparire(aduse, 'recipisa');
        }

        return null;
      })["catch"](function (err) {
        _this13.eroare = _this13.mesajEroare(err, 'Descărcarea recipiselor a eșuat');
      })["finally"](function () {
        _this13.recipiseInCurs = false;
      });
    },
    sterge: function sterge(declaratie) {
      ...
      this.$bvModal.msgBoxConfirm("\u0218terge\u021Bi declara\u021Bia ".concat(declaratie.tip, " pentru CUI ").concat(declaratie.cui, "?"), {
        ...
        _this14.$http["delete"]("/declaratii/".concat(declaratie.id)).then(function () {
          _this14.notifica('Declarația a fost ștearsă', 'success');

          _this14.incarcaLista();
        })["catch"](function (err) {
          _this14.eroare = _this14.mesajEroare(err, 'Ștergerea a eșuat');
        });
      });
    },
    mesajEroare: function mesajEroare(err, implicit) {
    ...
    explicaEroarea: function explicaEroarea(declaratie) {
      ...
      var antete = this.$http.defaults.headers.common; // Adresa API vine din window.api_url (definit în pagină); instanța axios
      // nu are baseURL propriu, așa că nu se poate citi de acolo.

      var baza = (window.api_url || this.$http.defaults.baseURL || '').replace(/\/+$/, '');
      var adresa = "".concat(baza, "/declaratii/").concat(declaratie.id, "/erori");
      fetch(adresa, {
        headers: {
        ...
        if (!raspuns.ok) throw new Error("HTTP ".concat(raspuns.status));
        return _this15.citesteFluxul(raspuns.body.getReader());
      })["catch"](function (err) {
        // Eșecul se arată în fereastră, nu în spatele ei: altfel utilizatorul
        // vede doar o fereastră goală și nu știe ce s-a întâmplat.
        _this15.explicatieInCurs = false;
        _this15.explicatieEroare = "Explica\u021Bia nu a putut fi ob\u021Binut\u0103 (".concat(err.message, ").");
      });
    },

    /** Citește răspunsul rând cu rând și adaugă fiecare problemă cum sosește. */
    citesteFluxul: function citesteFluxul(cititor) {
      var _this16 = this;
      ...
      var urmatorul = function urmatorul() {
        return cititor.read().then(function (_ref3) {
          var done = _ref3.done,
              value = _ref3.value;

          if (done) {
            _this16.explicatieInCurs = false;
            return null;
          }
    ...
    adaugaPas: function adaugaPas(rand) {
      if (!rand.trim()) return;
      var pas;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    optiuniFirmeInrolate: function optiuniFirmeInrolate() {
      return this.societati.map(function (societate) {
        return {
          cif: societate.cif,
    ...
    optiuniFirme: function optiuniFirme() {
      ...
      var potrivite = this.alerta.certificat_id ? this.societati.filter(function (societate) {
        return societate.certificat_id === _this2.alerta.certificat_id;
      }) : this.societati;
      return [{
        value: null,
  ...
  methods: {
    deschideAlerte: function deschideAlerte() {
      ...
      this.$http.get('/spv-alerte').then(function (_ref) {
        var data = _ref.data;
        _this3.alerte = data.data;
        _this3.certificate = data.certificate;
        _this3.societati = data.societati;
        _this3.tipuri = data.tipuri;
      })["catch"](function (err) {
        _this3.eroareAlerte = _this3.mesajEroareAlerte(err, 'Alertele nu au putut fi încărcate');
      });
    },
    ...
    salveazaAlerta: function salveazaAlerta() {
      ...
      cerere.then(function () {
        ...
        _this4.reincarcaAlerte();
      })["catch"](function (err) {
        _this4.eroareAlerte = _this4.mesajEroareAlerte(err, 'Alerta nu a putut fi salvată');
      });
    },
    stergeAlerta: function stergeAlerta(alerta) {
      ...
      this.$bvModal.msgBoxConfirm("\u0218terge\u021Bi alerta c\u0103tre ".concat(alerta.email, "?"), {
        ...
        _this5.$http["delete"]("/spv-alerte/".concat(alerta.id)).then(function () {
          _this5.reincarcaAlerte();
        })["catch"](function (err) {
          _this5.eroareAlerte = _this5.mesajEroareAlerte(err, 'Alerta nu a putut fi ștearsă');
        });
      });
    },
    ...
    incarcaSocietatiInrolate: function incarcaSocietatiInrolate() {
      ...
      return this.$http.get('/anaf-societati', {
        ...
        var data = _ref3.data;
        _this7.societati = data.data.map(function (societate) {
          return {
            cif: societate.cif,
    ...
    rezumatCitire: function rezumatCitire(payload, descarcare) {
      ...
      if (parti.length) return "ANAF a r\u0103spuns: ".concat(parti.join(', '), ".");
      var intoarse = payload.intoarse || 0;
      return "ANAF a r\u0103spuns, dar nu e nimic nou: cele ".concat(intoarse, " mesaje din ") + "ultimele ".concat(this.zile, " zile erau deja aduse.");
    },
    rezumatDescarcare: function rezumatDescarcare(rezultat) {
      ...
      if (rezultat.ramase) parti.push("".concat(rezultat.ramase, " r\u0103mase pentru urm\u0103toarea \xEEnc\u0103rcare"));
    ...
    openFile: function openFile(id) {
      ...
      this.$http.get('/spv/fisier', {
        ...
        _this8.error = 'Fișierul nu a putut fi deschis.';
      });
    },
    ...
    incarcaStocate: function incarcaStocate() {
      ...
      this.error = '';
      return this.$http.get('/spv/stocate').then(function (_ref4) {
        var data = _ref4.data;
        _this9.messages = Array.isArray(data.data.mesaje) ? data.data.mesaje : [];
      })["catch"](function (err) {
        _this9.error = _this9.mesajEroareAlerte(err, 'Mesajele stocate nu au putut fi încărcate');
      });
    },
    ...
    loadMessages: function loadMessages() {
      ...
      return this.$http.get('/spv', {
        ...
        if (response.data && response.data.success) {
          ...
          _this10.messages = Array.isArray(payload.mesaje) ? payload.mesaje : [];
          _this10.ultimaDescarcare = _this10.acum();
          _this10.ultimaDescarcareNumar = payload.noi || 0;
          window.localStorage.setItem('mesaje_ultima_descarcare', JSON.stringify({
            la: _this10.ultimaDescarcare,
            noi: _this10.ultimaDescarcareNumar
          }));
          /*
          ...
          _this10.infoDescarcare = tacut && !payload.noi ? '' : _this10.rezumatCitire(payload, response.data.descarcare);
        } else {
          _this10.error = response.data.message || 'Nu s-au putut încărca datele SPV';
        }
      })["catch"](function (err) {
        _this10.error = err.response && err.response.data && err.response.data.message ? err.response.data.message : 'Eroare la conectarea la SPV';
      })["finally"](function () {
        _this10.loading = false;
      });
    },
    alegeToateFirmele: function alegeToateFirmele() {
      this.firme = this.firme.length === this.societati.length ? [] : Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(this.optiuniFirmeInrolate);
    },
    ...
    reglaCronometrul: function reglaCronometrul() {
      ...
      this.cronometru = window.setInterval(function () {
        if (!_this11.loading) _this11.loadMessages(true);
      }, minute * 60 * 1000);
    }
  }
});
  ...
  computed: {
    ...
    societatiFiltrate: function societatiFiltrate() {
      ...
      return this.societati.filter(function (societate) {
        if (_this.filtre.tip && societate.tip !== _this.filtre.tip) return false;
        return ['cif', 'denumire'].every(function (cheie) {
          var cautat = (_this.filtre[cheie] || '').trim();
  ...
  methods: {
    ...
    incarcaLista: function incarcaLista() {
      ...
      this.$http.get('/anaf-societati', {
        ...
        _this2.societati = raspuns.data.data || [];
      })["catch"](function (err) {
        _this2.eroare = _this2.mesajEroare(err, 'Nu s-a putut încărca lista de entități');
      })["finally"](function () {
    ...
    sincronizeaza: function sincronizeaza() {
      ...
      this.$http.post('/anaf-societati/sincronizeaza').then(function (raspuns) {
        ...
        _this3.info = parti.join(', ');

        _this3.incarcaLista();
      })["catch"](function (err) {
        _this3.eroare = _this3.mesajEroare(err, 'Sincronizarea a eșuat');
      })["finally"](function () {
        _this3.sincronizareInCurs = false;
      });
    },
    ...
    solicita: function solicita() {
      ...
      this.progres = {
        pas: 'solicitari',
        facut: 0,
        total: cifuri.length || 1,
        text: 'Se trimit solicitările...'
      };
      this.trimiteSolicitari(cifuri).then(function (rezumat) {
        return _this4.descarcaMesajeNoi(rezumat);
      }).then(function (rezumat) {
        return _this4.preiaRaspunsurile(rezumat);
      }).then(function (rezumat) {
        var parti = [];
        ...
        _this4.info = parti.length ? parti.join(', ') : 'Nu era nimic de solicitat.';
        if (_this4.erori.length) _this4.eroare = _this4.erori.join(' | ');

        _this4.incarcaLista();
      })["catch"](function (err) {
        _this4.eroare = _this4.mesajEroare(err, 'Solicitarea a eșuat');
      })["finally"](function () {
        _this4.solicitareInCurs = false;
        _this4.progres = null;
      });
    },
    ...
    trimiteSolicitari: function trimiteSolicitari(cifuri) {
      ...
      var lot = function lot(i) {
        ...
        var acum = cifuri.slice(i, i + _this5.FIRME_PE_LOT); // Primul lot merge fără listă: acolo se recitesc și documentele vechi.
        ...
        return _this5.$http.post('/anaf-societati/solicita', i === 0 ? Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_1__["default"])({
          cif: acum
        }, date) : date).then(function (raspuns) {
          var _this5$erori;
          ...
          if (r.erori && r.erori.length) (_this5$erori = _this5.erori).push.apply(_this5$erori, Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(r.erori));
          return lot(i + _this5.FIRME_PE_LOT);
        });
      };
     ...
     */
    descarcaMesajeNoi: function descarcaMesajeNoi(rezumat) {
      var _this6 = this;
      ...
      var runda = function runda(trecute) {
        ...
        return _this6.$http.get('/spv', {
          ...
          if (d.erori && d.erori.length) (_this6$erori = _this6.erori).push.apply(_this6$erori, Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(d.erori)); // Se oprește când nu mai rămâne nimic sau când o rundă n-a mai adus nimic.

          if (!d.ramase || !d.descarcate || trecute >= _this6.RUNDE_MAXIME) {
            return rezumat;
          }
    ...
    preiaRaspunsurile: function preiaRaspunsurile(rezumat) {
      var _this7 = this;
      ...
      var runda = function runda(trecute) {
        ...
        return _this7.$http.post("/spv/solicitari/preia?limita=".concat(_this7.RASPUNSURI_PE_LOT)).then(function (raspuns) {
          var _this7$erori;

          var r = raspuns.data.data || {};
          rezumat.preluate += r.preluate || 0;
          if (r.erori && r.erori.length) (_this7$erori = _this7.erori).push.apply(_this7$erori, Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(r.erori)); // Cele fără răspuns încă nu se mai așteaptă: vin la o rulare viitoare.

          if (!r.preluate || trecute >= _this7.RUNDE_MAXIME) {
            return rezumat;
          }
    ...
    editeaza: function editeaza(societate) {
      this.formular = Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_1__["default"])({}, societate);
    ...
    salveaza: function salveaza() {
      ...
      this.$http.put("/anaf-societati/".concat(this.formular.id), {
        ...
        _this8.eroare = _this8.mesajEroare(err, 'Salvarea a eșuat');
      });
    },
    mesajEroare: function mesajEroare(err, implicit) {
      return err.response && err.response.data && err.response.data.message ? err.response.data.message : implicit;
...
/* harmony import */ var core_js_modules_es_string_pad_start_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! core-js/modules/es.string.pad-start.js */ "./node_modules/core-js/modules/es.string.pad-start.js");
/* harmony import */ var core_js_modules_es_string_pad_start_js__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_string_pad_start_js__WEBPACK_IMPORTED_MODULE_13__);
  ...
  computed: {
    ...
    solicitariFiltrate: function solicitariFiltrate() {
      ...
      return this.solicitari.filter(function (solicitare) {
        if (_this.filtre.stare && solicitare.stare !== _this.filtre.stare) return false;
        return Object.keys(_this.filtre).filter(function (cheie) {
          return cheie !== 'stare';
    ...
    poateTrimite: function poateTrimite() {
      ...
      return (this.parametriTip[this.tipDocument] || []).filter(function (p) {
        ...
        var valoare = {
          ...
          luna: _this2.luna,
          motiv: _this2.motiv,
          numar_inregistrare: _this2.numarInregistrare
        }[p];
  ...
  methods: {
    ...
    incarcaSocietati: function incarcaSocietati() {
      ...
      this.$http.get('/anaf-societati', {
        ...
        var data = _ref.data;
        _this3.societati = data.data.map(function (societate) {
          return {
            cif: societate.cif,
            eticheta: societate.denumire ? "".concat(societate.denumire, " (").concat(societate.cif, ")") : societate.cif
          };
        ...
        _this3.eroare = _this3.mesajEroare(err, 'Entitățile înrolate nu au putut fi încărcate');
      })["finally"](function () {
        _this3.societatiInCurs = false;
      });
    },
    alegeToate: function alegeToate() {
      this.firme = this.firme.length === this.societati.length ? [] : Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(this.societati);
    },
    ...
    deschide: function deschide(solicitare) {
      ...
      this.$http.get("/spv/solicitari/".concat(solicitare.id, "/fisier"), {
        ...
        _this4.eroare = 'Documentul nu a putut fi deschis.';
      });
    },
    ...
    incarcaLista: function incarcaLista() {
      ...
      return this.$http.get('/spv/solicitari').then(function (raspuns) {
        _this5.solicitari = raspuns.data.data || [];
        _this5.parametriTip = raspuns.data.tipuri || {};
        _this5.tipuri = Object.keys(_this5.parametriTip).map(function (tip) {
          return {
            value: tip,
            text: tip
          };
        ...
        if (!_this5.tipDocument && _this5.tipuri.length) {
          _this5.tipDocument = _this5.tipuri[0].value;
        }
      })["catch"](function (err) {
        _this5.eroare = _this5.mesajEroare(err, 'Nu s-au putut încărca solicitările');
      })["finally"](function () {
        _this5.listaInCurs = false;
      });
    },
    trimite: function trimite() {
      ...
      this.$http.post('/spv/solicitari', {
        ...
        _this6.notifica("".concat(trimise, " solicitare/solicit\u0103ri trimise c\u0103tre SPV"), 'success');

        if (raspuns.data.erori && raspuns.data.erori.length) {
          _this6.eroare = raspuns.data.erori.join(' | ');
        }
        ...
        var date = err.response && err.response.data;
        _this6.eroare = date && date.erori && date.erori.length ? date.erori.join(' | ') : _this6.mesajEroare(err, 'Solicitarea a eșuat');
      })["finally"](function () {
        _this6.trimiteInCurs = false;
      });
    },
    ...
    preia: function preia() {
      ...
      var tacut = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      this.eroare = '';
      this.preiaInCurs = true; // Ce era deja preluat înainte: la sfârșit se tipăresc doar noutățile.

      var inainte = this.solicitari.filter(function (s) {
        return s.cale_fisier;
      }).map(function (s) {
        return s.id;
      });
      return this.$http.post('/spv/solicitari/preia').then(function (raspuns) {
        var rezultat = raspuns.data.data;
        _this7.ultimaPreluare = _this7.acum();
        _this7.ultimaPreluareNumar = rezultat.preluate || 0;
        window.localStorage.setItem('solicitari_ultima_preluare', JSON.stringify({
          la: _this7.ultimaPreluare,
          preluate: _this7.ultimaPreluareNumar
        }));

        if (!tacut || rezultat.preluate > 0) {
          _this7.notifica("Verificate: ".concat(rezultat.verificate, ", r\u0103spunsuri noi: ").concat(rezultat.preluate), rezultat.preluate > 0 ? 'success' : 'info');
        }

        if (rezultat.erori && rezultat.erori.length) {
          _this7.eroare = rezultat.erori.join(' | ');
        }

        return _this7.incarcaLista().then(function () {
          if (!_this7.tiparire) return null;

          var noi = _this7.solicitari.filter(function (s) {
            return s.cale_fisier && inainte.indexOf(s.id) === -1;
          }).map(function (s) {
            return s.id;
          });

          return noi.length ? _this7.tipareste(noi) : null;
        });
      })["catch"](function (err) {
        _this7.eroare = _this7.mesajEroare(err, 'Preluarea răspunsurilor a eșuat');
      })["finally"](function () {
        _this7.preiaInCurs = false;
      });
    },
    ...
    tipareste: function tipareste(ids) {
      ...
      return this.$http.post('/spv/solicitari/tipareste', {
        ...
        _this8.notifica("".concat(data.data.documente, " documente trimise la \u201E").concat(data.data.imprimanta, "\u201D"), 'success');
      })["catch"](function (err) {
        var motiv = _this8.mesajEroare(err, 'programul local nu a răspuns.');

        _this8.eroare = "R\u0103spunsurile au fost preluate, dar tip\u0103rirea nu a reu\u0219it: ".concat(motiv);
      });
    },
    ...
    reglaCronometrul: function reglaCronometrul() {
      ...
      this.cronometru = window.setInterval(function () {
        ...
        if (!_this9.preiaInCurs && _this9.inAsteptare) {
          _this9.preia(true);
        }
      }, minute * 60 * 1000);
    },
    sterge: function sterge(solicitare) {
      ...
      this.$http["delete"]("/spv/solicitari/".concat(solicitare.id)).then(function () {
        _this10.notifica('Solicitarea a fost ștearsă', 'success');

        _this10.incarcaLista();
      })["catch"](function (err) {
        _this10.eroare = _this10.mesajEroare(err, 'Ștergerea a eșuat');
      });
    },
    mesajEroare: function mesajEroare(err, implicit) {
      return err.response && err.response.data && err.response.data.message ? err.response.data.message : implicit;
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/app_pages/Spv.vue?vue&type=template&id=50cb4596&":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/app_pages/Spv.vue?vue&type=template&id=50cb4596& ***!
  \***************************************************************************************************************************************************************************************************************/
                        ...
                        _c(
                          "b-button",
                          {
                            ...
                            attrs: {
                              size: "sm",
                              variant: "outline-secondary",
                              disabled: _vm.licentaInCurs === rand.item.id,
                              title:
                        ...
                        _c(
                          "b-button",
                          {
                            ...
                            attrs: {
                              ...
                              disabled: _vm.certificatActiv === rand.item.id,
                              title:
                              ...
                              ? _c(
                                  "b-button",
                                  {
                                    ...
                                    attrs: {
                                      ...
                                      title:
                                        "Explică eroarea pe înțelesul tuturor",
                                    },
                                    on: {
                                      click: function ($event) {
      ...
      [
        _c("div", { staticClass: "row mb-3" }, [
                  ...
                  _c(
                    ...
                    [
                      _c("small", [
                        _vm._v(
                          _vm._s(
                            _vm.firme.length === _vm.societati.length
                              ? "niciuna"
                              : "toate"
                          )
                        ),
          ...
          _c(
            ...
            {
              staticClass:
                "col-md-6 d-flex flex-column justify-content-end align-items-end",
            },
            [
              _c(
                "div",
            ...
            _c(
              ...
              [
                ...
                _c(
                  ...
                  { attrs: { md: "6" } },
                  [
                    _c("label", [_vm._v("Tipul documentului")]),
                    _vm._v(" "),
                    _c("b-form-input", {
                      staticClass: "mb-1",
                      attrs: {
                ...
                [
                  _c(
                    "b-form-checkbox",
                    {
                      on: { change: _vm.incarcaLista },
                      model: {
                        value: _vm.doarActive,
                        callback: function ($$v) {
                          _vm.doarActive = $$v
                        },
                        expression: "doarActive",
                      },
                    },
                    [_vm._v("\n          Doar cele active\n        ")]
                  ),
                ...
                fn: function (rand) {
                  return [
                    _c(
                      ...
                      {
                        attrs: {
                          variant: rand.item.activ ? "success" : "secondary",
                        },
                      },
                      [
                        _vm._v(
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Spv_vue_vue_type_template_id_50cb4596___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Spv.vue?vue&type=template&id=50cb4596& */ "./resources/js/src/views/app_pages/Spv.vue?vue&type=template&id=50cb4596&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Spv_vue_vue_type_template_id_50cb4596___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Spv_vue_vue_type_template_id_50cb4596___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/***/ "./resources/js/src/views/app_pages/Spv.vue?vue&type=template&id=50cb4596&":
/*!*********************************************************************************!*\
  !*** ./resources/js/src/views/app_pages/Spv.vue?vue&type=template&id=50cb4596& ***!
  \*********************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Spv_vue_vue_type_template_id_50cb4596___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib??vue-loader-options!./Spv.vue?vue&type=template&id=50cb4596& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/app_pages/Spv.vue?vue&type=template&id=50cb4596&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Spv_vue_vue_type_template_id_50cb4596___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Spv_vue_vue_type_template_id_50cb4596___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
