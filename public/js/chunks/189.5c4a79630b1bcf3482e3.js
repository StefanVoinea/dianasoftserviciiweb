  ...
  methods: {
    ...
    solicita: function solicita() {
      ...
      this.ceEDeja().then(function () {
        return _this4.trimiteSolicitari(cifuri);
    ...
    ceEDeja: function ceEDeja() {
      ...
      return this.$http.get('/spv', {
        ...
        if (d.erori && d.erori.length) (_this5$erori = _this5.erori).push.apply(_this5$erori, Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_1__["default"])(d.erori));
        _this5.progres = {
          pas: 'mesaje',
          facut: 1,
          total: 1,
        ...
        return _this5.$http.post("/spv/solicitari/preia?zile=1&limita=".concat(_this5.RASPUNSURI_PE_LOT));
      }).then(function () {
        ...
        _this5.erori.push(_this5.mesajEroare(err, 'Documentele venite deja nu au putut fi citite'));
      });
    },
    ...
    trimiteSolicitari: function trimiteSolicitari(cifuri) {
      ...
      var lot = function lot(i) {
        ...
        var acum = cifuri.slice(i, i + _this6.FIRME_PE_LOT);
        _this6.progres = {
          pas: 'solicitari',
          facut: i,
          total: cifuri.length,
        ...
        return _this6.$http.post('/anaf-societati/solicita', {
          cif: acum,
          reinterpreteaza: i === 0
        }).then(function (raspuns) {
          var _this6$erori;
          ...
          if (r.erori && r.erori.length) (_this6$erori = _this6.erori).push.apply(_this6$erori, Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_1__["default"])(r.erori));
          return lot(i + _this6.FIRME_PE_LOT);
        });
      };
    ...
    descarcaMesajeNoi: function descarcaMesajeNoi(rezumatul) {
      ...
      var runda = function runda(trecute) {
        ...
        return _this7.$http.get('/spv', {
          ...
          if (d.erori && d.erori.length) (_this7$erori = _this7.erori).push.apply(_this7$erori, Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_1__["default"])(d.erori)); // Se oprește când nu mai rămâne nimic sau când o rundă n-a mai adus nimic.

          if (!d.ramase || !d.descarcate || trecute >= _this7.RUNDE_MAXIME) {
            return rezumat;
          }
    ...
    preiaRaspunsurile: function preiaRaspunsurile(rezumatul) {
      ...
      var runda = function runda(trecute) {
        ...
        return _this8.$http.post("/spv/solicitari/preia?limita=".concat(_this8.RASPUNSURI_PE_LOT)).then(function (raspuns) {
          var _this8$erori;

          var r = raspuns.data.data || {};
          rezumat.preluate += r.preluate || 0;
          if (r.erori && r.erori.length) (_this8$erori = _this8.erori).push.apply(_this8$erori, Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_1__["default"])(r.erori)); // Cele fără răspuns încă nu se mai așteaptă: vin la o rulare viitoare.

          if (!r.preluate || trecute >= _this8.RUNDE_MAXIME) {
            return rezumat;
          }
    ...
    salveaza: function salveaza() {
      ...
      this.$http.put("/anaf-societati/".concat(this.formular.id), {
        ...
        _this9.eroare = _this9.mesajEroare(err, 'Salvarea a eșuat');
      });
    },
    mesajEroare: function mesajEroare(err, implicit) {
      return err.response && err.response.data && err.response.data.message ? err.response.data.message : implicit;
...
var render = function () {
  ...
  return _c(
    ...
    [
      _c("img", {
        staticClass: "spv-sigla mb-1",
        attrs: {
          src: _vm.sigla,
          alt: "DianaSoft → SPV Curier — Automatizare mesaje și declarații ANAF",
        },
      }),
      _vm._v(" "),
      _c(
