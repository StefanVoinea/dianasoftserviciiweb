...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      password: '',
      userEmail: '',
      sideImg: __webpack_require__(/*! @/assets/images/pages/login-dianasoft.svg */ "./resources/js/src/assets/images/pages/login-dianasoft.svg"),
      // validation rules
  ...
  computed: {
    ...
    imgUrl: function imgUrl() {
      if (_store_index__WEBPACK_IMPORTED_MODULE_12__["default"].state.appConfig.layout.skin === 'dark') {
        ...
        this.sideImg = __webpack_require__(/*! @/assets/images/pages/login-dianasoft.svg */ "./resources/js/src/assets/images/pages/login-dianasoft.svg");
        return this.sideImg;
      }
  ...
  methods: {
    acceptAlert: function acceptAlert(color) {
      ...
      var socCurenta = JSON.stringify(this.userCompanies.find(function (company) {
        return company.value === _this.societateSelectata;
      }));

      if (socCurenta != undefined) {
        // localStorage.setItem('societateaCurenta', socCurenta)
        this.$store.dispatch('app/societateaCurenta', socCurenta).then(function (response) {
          _this.getCookiesLocal();
        });
      } else {
        this.$store.dispatch('app/destroyToken').then(function (response) {
    ...
    getCookiesLocal: function getCookiesLocal() {
      var _this3 = this;

      var date = new Date();
      var firstDay = new Date(date.getFullYear(), date.getMonth(), 1);
      this.$store.dispatch('app/lunaCurenta', firstDay);
      this.$globalHelpers.updateCookiesLocal().then(function (response) {
        _this3.activePrompt = false;

        if (new Date(_this3.userData.data_expirare_parola) <= new Date()) {
          _this3.$router.replace({
            name: 'pages-account-setting'
          }).then(function () {
            _this3.$bvToast.toast("Parola expirata, va rugam , modificati parola!", {
              title: "ATENTIE! ",
              variant: "danger",
              solid: true,
              appendToast: false,
          ...
          _this3.$router.replace(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_13__["getHomeRouteForLoggedInUser"])('admin'));
        }
      })["catch"](function (error) {
        _this3.$refs.loginForm.setErrors(error.response.data.error);
    ...
    login: function login() {
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          ...
          _this4.activePrompt = false;

          _this4.$store.dispatch('app/retrieveToken', {
            email: _this4.userEmail,
            password: _this4.password
          }).then(function (response) {
            _this4.$store.dispatch('app/retrieveUser').then(function (response) {
              _this4.userData = response.data;
              _this4.userData.role = "admin";
              ...
              if (response.data.companies.length > 1) //LUCREAZA PE MAI MULTE SOCIETATI 
                {
                  ...
                  _this4.userCompanies = companies;
                  _this4.activePrompt = true;
                } else {
                if (response.data.companies.length == 1) //LUCREAZA PE O SOCIETATE
                  {
                    var socCurenta = JSON.stringify(response.data.companies[0]);

                    _this4.$store.dispatch('app/societateaCurenta', socCurenta).then(function (response) {
                      _this4.getCookiesLocal();
                    });
              ...
              _this4.$bvToast.toast("Credentiale incorecte!", {
                title: "ATENTIE! ",
                variant: "danger",
                solid: true,
                appendToast: false,
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/pages/authentication/Login.vue?vue&type=style&index=1&id=92be1b32&lang=scss&scoped=true&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--7-2!./node_modules/sass-loader/dist/cjs.js??ref--7-3!./node_modules/sass-loader/dist/cjs.js??ref--11-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/pages/authentication/Login.vue?vue&type=style&index=1&id=92be1b32&lang=scss&scoped=true& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var content = __webpack_require__(/*! !../../../../../../node_modules/css-loader/dist/cjs.js!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/src??ref--7-2!../../../../../../node_modules/sass-loader/dist/cjs.js??ref--7-3!../../../../../../node_modules/sass-loader/dist/cjs.js??ref--11-0!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./Login.vue?vue&type=style&index=1&id=92be1b32&lang=scss&scoped=true& */ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/pages/authentication/Login.vue?vue&type=style&index=1&id=92be1b32&lang=scss&scoped=true&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/pages/authentication/Login.vue?vue&type=template&id=92be1b32&scoped=true&":
/*!****************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/pages/authentication/Login.vue?vue&type=template&id=92be1b32&scoped=true& ***!
  \****************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
      ...
      _c(
        ...
        [
          _c(
            "b-col",
            {
              staticClass: "d-none d-lg-flex align-items-center p-0",
              attrs: { lg: "9" },
            },
            [
              _c(
                ...
                {
                  staticClass:
                    "locul-imaginii w-100 h-100 d-lg-flex align-items-center justify-content-center",
                },
                [
                  _c("b-img", {
                    staticClass: "imagine-login",
                    attrs: { src: _vm.imgUrl, alt: "DianaSoft" },
                  }),
                ],
                1
              ),
...
/***/ "./resources/js/src/assets/images/pages/login-dianasoft.svg":
/*!******************************************************************!*\
  !*** ./resources/js/src/assets/images/pages/login-dianasoft.svg ***!
  \******************************************************************/
/*! no static exports found */
...
module.exports = "/images/pages/login-dianasoft.svg";
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Login_vue_vue_type_template_id_92be1b32_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Login.vue?vue&type=template&id=92be1b32&scoped=true& */ "./resources/js/src/views/pages/authentication/Login.vue?vue&type=template&id=92be1b32&scoped=true&");
...
/* harmony import */ var _Login_vue_vue_type_style_index_1_id_92be1b32_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Login.vue?vue&type=style&index=1&id=92be1b32&lang=scss&scoped=true& */ "./resources/js/src/views/pages/authentication/Login.vue?vue&type=style&index=1&id=92be1b32&lang=scss&scoped=true&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_4__["default"])(
  ...
  _Login_vue_vue_type_template_id_92be1b32_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Login_vue_vue_type_template_id_92be1b32_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "92be1b32",
  null
...
/***/ "./resources/js/src/views/pages/authentication/Login.vue?vue&type=style&index=1&id=92be1b32&lang=scss&scoped=true&":
/*!*************************************************************************************************************************!*\
  !*** ./resources/js/src/views/pages/authentication/Login.vue?vue&type=style&index=1&id=92be1b32&lang=scss&scoped=true& ***!
  \*************************************************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Login_vue_vue_type_style_index_1_id_92be1b32_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/style-loader!../../../../../../node_modules/css-loader/dist/cjs.js!../../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../../node_modules/postcss-loader/src??ref--7-2!../../../../../../node_modules/sass-loader/dist/cjs.js??ref--7-3!../../../../../../node_modules/sass-loader/dist/cjs.js??ref--11-0!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./Login.vue?vue&type=style&index=1&id=92be1b32&lang=scss&scoped=true& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/sass-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/pages/authentication/Login.vue?vue&type=style&index=1&id=92be1b32&lang=scss&scoped=true&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Login_vue_vue_type_style_index_1_id_92be1b32_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Login_vue_vue_type_style_index_1_id_92be1b32_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Login_vue_vue_type_style_index_1_id_92be1b32_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_2_node_modules_sass_loader_dist_cjs_js_ref_7_3_node_modules_sass_loader_dist_cjs_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Login_vue_vue_type_style_index_1_id_92be1b32_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));


/***/ }),

/***/ "./resources/js/src/views/pages/authentication/Login.vue?vue&type=template&id=92be1b32&scoped=true&":
/*!**********************************************************************************************************!*\
  !*** ./resources/js/src/views/pages/authentication/Login.vue?vue&type=template&id=92be1b32&scoped=true& ***!
  \**********************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Login_vue_vue_type_template_id_92be1b32_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./Login.vue?vue&type=template&id=92be1b32&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/pages/authentication/Login.vue?vue&type=template&id=92be1b32&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Login_vue_vue_type_template_id_92be1b32_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Login_vue_vue_type_template_id_92be1b32_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
