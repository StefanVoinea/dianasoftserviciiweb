  ...
  methods: {
    ...
    semneazaValidate: function semneazaValidate(declaratii) {
      ...
      var urmatoarea = function urmatoarea(i) {
        if (i >= declaratii.length) {
          if (esuate.length) {
            _this6.eroare = "Nu s-au putut semna: ".concat(esuate.join(' | '));
          }

          _this6.notifica("".concat(declaratii.length - esuate.length, " din ").concat(declaratii.length, " semnate"), esuate.length ? 'warning' : 'success');

          return null;
        }

        var declaratie = declaratii[i];
        _this6.semnareInCurs = "".concat(declaratie.tip, " (").concat(i + 1, " din ").concat(declaratii.length, ")");
        return _this6.$http.post("/declaratii/".concat(declaratie.id, "/semneaza")).then(function () {
          reusite.push(declaratie);
        })["catch"](function (err) {
          esuate.push("".concat(declaratie.tip, " ").concat(declaratie.cui, ": ").concat(_this6.mesajEroare(err, 'semnare eșuată')));
        }).then(function () {
      ...
      return urmatoarea(0).then(function () {
        _this6.semnareInCurs = ''; // Se adună doar cele semnate acum, nu tot ce e semnat în tabel.

        if (_this6.tiparire && reusite.length) {
          _this6.semnareInCurs = 'fișierul pentru tipărire';
          return _this6.descarcaPentruTiparire(reusite.map(function (d) {
            return d.id;
          })).then(function () {
            _this6.semnareInCurs = '';
          });
        }

        return null;
      }).then(function () {
        return _this6.depuneDinSesiune([].concat(Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_1__["default"])(venitesemnate), reusite));
      });
    },
    ...
    descarcaPentruTiparire: function descarcaPentruTiparire(ids) {
      ...
      return this.$http.post('/declaratii/concateneaza', Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])(Object(C_dianasoft_serviciiweb_web_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, date), {}, {
        ...
        _this7.$bvToast.toast("".concat(data.data.documente, " documente trimise la \u201E").concat(data.data.imprimanta, "\u201D."), {
        ...
        _this7.eroare = "".concat(ceAnume, " sunt gata, dar tip\u0103rirea nu a reu\u0219it: ").concat(motiv, " Se descarc\u0103 fi\u0219ierul.");
        return _this7.descarcaFisierUnit(date, ids.length);
      });
    },
    ...
    descarcaFisierUnit: function descarcaFisierUnit(date, cate) {
      ...
      return this.$http.post('/declaratii/concateneaza', date, {
        ...
        _this8.eroare = 'Nici fișierul pentru tipărire nu a putut fi creat.';
      });
    },
    ...
    depuneSemnate: function depuneSemnate() {
      ...
      this.$bvModal.msgBoxConfirm("Se trimit acum la ANAF ".concat(numite, " (").concat(listate, "). Dup\u0103 trimitere nu mai pot fi retrase."), {
        ...
        return _this9.trimiteLaAnaf(declaratii);
      });
    },
    ...
    trimiteLaAnaf: function trimiteLaAnaf(declaratii) {
      ...
      var urmatoarea = function urmatoarea(i) {
        if (i >= declaratii.length) {
          if (esuate.length) {
            _this10.eroare = "Nu s-au putut depune: ".concat(esuate.join(' | '));
          }

          _this10.notifica("".concat(declaratii.length - esuate.length, " din ").concat(declaratii.length, " depuse"), esuate.length ? 'warning' : 'success');

          return null;
        }

        var declaratie = declaratii[i];
        _this10.depunereMesaj = "".concat(declaratie.tip, " (").concat(i + 1, " din ").concat(declaratii.length, ")");
        return _this10.$http.post("/declaratii/".concat(declaratie.id, "/depune"))["catch"](function (err) {
          esuate.push("".concat(declaratie.tip, " ").concat(declaratie.cui, ": ").concat(_this10.mesajEroare(err, 'depunere eșuată')));
        }).then(function () {
          return urmatoarea(i + 1);
        });
      };
      ...
      return urmatoarea(0).then(function () {
        _this10.depunereInCurs = false;
        _this10.depunereMesaj = '';
    ...
    actiune: function actiune(declaratie, tip) {
      ...
      this.$http.post("/declaratii/".concat(declaratie.id, "/").concat(tip)).then(function () {
        _this11.notifica(mesaje[tip], 'success');

        _this11.incarcaLista();
      })["catch"](function (err) {
        _this11.eroare = _this11.mesajEroare(err, 'Operația a eșuat');
    ...
    verificaRecipise: function verificaRecipise() {
      ...
      this.$http.post('/declaratii/recipise').then(function (raspuns) {
        ...
        _this12.ultimaDescarcareNumar = rezultat.descarcate || 0;
        window.localStorage.setItem('declaratii_recipise_ultima', JSON.stringify({
          la: _this12.ultimaDescarcare,
          descarcate: _this12.ultimaDescarcareNumar
        }));

        if (!tacut || rezultat.descarcate > 0) {
          _this12.notifica("Verificate: ".concat(rezultat.verificate, ", recipise desc\u0103rcate: ").concat(rezultat.descarcate), rezultat.descarcate > 0 ? 'success' : 'info');
        }

        if (rezultat.erori && rezultat.erori.length) {
          _this12.eroare = rezultat.erori.join(' | ');
        }

        _this12.incarcaLista(); // Recipisele venite acum se pot aduna într-un singur fișier de tipărit.


        var aduse = rezultat.descarcate_id || [];

        if (_this12.tiparireRecipise && aduse.length) {
          return _this12.descarcaPentruTiparire(aduse, 'recipisa');
        }

        return null;
      })["catch"](function (err) {
        _this12.eroare = _this12.mesajEroare(err, 'Descărcarea recipiselor a eșuat');
      })["finally"](function () {
        _this12.recipiseInCurs = false;
      });
    },
    sterge: function sterge(declaratie) {
      ...
      this.$bvModal.msgBoxConfirm("\u0218terge\u021Bi declara\u021Bia ".concat(declaratie.tip, " pentru CUI ").concat(declaratie.cui, "?"), {
        ...
        _this13.$http["delete"]("/declaratii/".concat(declaratie.id)).then(function () {
          _this13.notifica('Declarația a fost ștearsă', 'success');
    ...
    explicaEroarea: function explicaEroarea(declaratie) {
      ...
      fetch(adresa, {
        ...
        return _this14.citesteFluxul(raspuns.body.getReader());
      })["catch"](function (err) {
        ...
        _this14.explicatieEroare = "Explica\u021Bia nu a putut fi ob\u021Binut\u0103 (".concat(err.message, ").");
      });
    },
